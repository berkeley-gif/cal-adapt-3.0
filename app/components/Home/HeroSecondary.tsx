    ...
    return (
        <div className="secondary-hero">
            ...
            <div className="secondary-hero__content">
                ...
                <Button className={isMobile ? 'hidden' : ''} data-path="/dashboard/data-explorer?metric=fire-weather" variant="contained" color="primary" onClick={handleClick}>See it in the Data Explorer</Button>
            </div>
        </div>
    )
