        ...
        <Box className="renewables-tool tool-container tool-container--padded" aria-label="Renewables Visualizer" role="region">
            ...
            <Box className="renewables-tool__intro" style={{ 'maxWidth': '860px' }}>
                ...
                <Typography variant="body1">
                    <a style={{ 'textDecoration': 'underline', 'display': 'inline-block' }} href="https://drive.google.com/file/d/1YSe6oi6GksTvwUVBhkv-ZLrHkr3SzMqq/view?usp=drive_link" target="_blank" aria-label="Read more in the documentation">Read more in the documentation</a>
                </Typography>
            </Box>
